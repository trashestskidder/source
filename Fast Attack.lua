            ...
            if UFFF then 
                pcall(function()
                    if conchosetting and type(conchosetting) == "table" then 
                        if conchosetting and conchosetting.AutoMastery then 
                            ToiCanOxi = 2 
                            atack()
                            if conchosetting.FastAttackDelay and type(conchosetting.FastAttackDelay) == "number" and conchosetting.FastAttackDelay >= 0.1 then 
                                wait(conchosetting.FastAttackDelay)
                            else
                                conchosetting.FastAttackDelay = 0.2 
                                wait(conchosetting.FastAttackDelay)
                            end
                        ...
                        elseif CountAttack >= FastAttackSettings["CDAAT"] then 
                            ...
                            atack()
                            if conchosetting.FastAttackDelay and type(conchosetting.FastAttackDelay) == "number" and conchosetting.FastAttackDelay >= 0.1 then 
                                wait(conchosetting.FastAttackDelay * 2)
                            else
                                conchosetting.FastAttackDelay = 0.2 
                                wait(conchosetting.FastAttackDelay * 2)
                            end
