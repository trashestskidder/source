...
NameHub.TextColor3 = Color3.fromRGB(12, 99, 237)
NameHub.TextSize = 85
...
HopIn.Font = Enum.Font.GothamSemibold
...
ClickTo.Font = Enum.Font.GothamSemibold
ClickTo.Text = "Click here hop faster"
...
function NotifyHop(reasonreal, time)
